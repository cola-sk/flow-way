...
- [record_demo](record_demo.md) — record_demo

## Files

116 per-file wiring cards mirror the source tree under `graft/` (99 carry extracted symbols). They are deliberately not enumerated here —
